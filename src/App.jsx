...
export default function App() {
  ...
  const projects = [
    ...
    },
    {
      ...
      img: "https://s3-alpha.figma.com/hub/file/5551975764/45488a29-99f3-4c64-9549-629255337435-cover.png",
      link: "#",
    },
    {
      id: 7,
      title: "FitBuddy Health App",
      img: "https://cdn.dribbble.com/userupload/11887446/file/original-f34f4fd38dfe7aa5e9397dcafd7e536c.png?resize=400x300",
      link: "#",
    },
    {
      id: 8,
      title: "EduLearn Online Platform",
      img: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRgNC2pw_5af9rM78056DxA5dXf00n7QzY2mw&s",
      link: "#",
    },
    {
      id: 9,
      title: "ShopEase E-commerce App",
      img: "https://www.figma.com/community/resource/a2938e41-93fa-4836-a3ee-b3c3dc5f861a/thumbnail",
      link: "#",
    },
  ];
  ...
  const feedbacks = [
    {
      name: "Subhan Raza",
      company: "Namrah Security Management",
      text: "Vinod transformed our app design! Clean, modern, and user-friendly.",
    },
    {
      name: "Harmeek Kaur",
      company: "Azzunique Softwares",
      text: "Amazing experience working with Vinod. He really understands users.",
    },
    {
      name: "Vikas Solanki",
      company: "Doomshell Softwares",
      text: "His designs gave our brand a fresh and professional identity.",
    },
  ];
  ...
  const clientLogos = [
    {
      id: 1,
      logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQzrUzFPk54hLe2ASbQAK1NFUMLcBP6izlzGw&s",
    },
    {
      id: 2,
      logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSnOT-CVAF6eviF89Iobd0Cee32DGXJubxsnrIVaqN3Wz08UnDEVZaInTrmYVEMxaGMGh4&usqp=CAU",
    },
    {
      id: 3,
      logo: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSBlgCSHM3jZXcAw8nXbnWSO3gauKou9T9z9pCw-sMQHAkT9nDQCgGekmhgiEpxZeqBf5U&usqp=CAU",
    },
    {
      id: 4,
      logo: "https://play-lh.googleusercontent.com/p2v93Ycop_1x6hart9lbdqzhHN1wvx4tlRRhpQlI7mYQ_OcHbTYBbYUpdyFwYnggKg",
    },
  ];
      ...
      <div className="min-h-screen bg-black/50">
        ...
        <header className="fixed top-0 left-0 w-full bg-black/30 backdrop-blur-md z-50 shadow-lg">
          ...
          {menuOpen && (
            <div className="md:hidden bg-black/90 text-center py-4 space-y-4">
              <a href="#expertise" className="block hover:text-pink-400">
                Expertise
              </a>
              <a href="#projects" className="block hover:text-pink-400">
                Projects
              </a>
              <a href="#process" className="block hover:text-pink-400">
                Process
              </a>
              <a href="#about" className="block hover:text-pink-400">
                About
              </a>
              <a href="#feedback" className="block hover:text-pink-400">
                Feedback
              </a>
        ...
        <section className="relative flex flex-col items-center justify-center text-center min-h-screen px-6 pt-24">
          ...
          <p className="mt-6 text-lg max-w-2xl text-gray-300 relative z-10">
            Creative UI/UX Designer with a deep passion for designing seamless
            digital experiences. Specialized in Figma, Adobe XD, Photoshop,
            Canva, HTML & CSS. I blend creativity and functionality to craft
            designs that delight users and drive results.
          </p>
        ...
        <section id="expertise" className="py-20 bg-black/30 text-center">
          ...
          <p className="max-w-3xl mx-auto mb-10 text-gray-300">
            Over the 2 years, I’ve honed my skills across multiple design
            platforms and tools. My expertise lies in creating intuitive,
            user-friendly, and visually engaging interfaces for both mobile and
            web applications.
          </p>
        ...
        <section id="projects" className="py-20 text-center">
          ...
          <div className="max-w-6xl mx-auto grid md:grid-cols-2 lg:grid-cols-3 gap-10 px-6">
            {projects
              .slice(0, showMore ? projects.length : 5)
              .map((p) => (
                <div
                  key={p.id}
        ...
        <section id="process" className="py-20 bg-black/30 text-center">
          ...
          <p className="max-w-3xl mx-auto mb-12 text-gray-300">
            I follow a structured design workflow that ensures every project is
            user-centered, functional, and visually compelling.
          </p>
          <div className="max-w-5xl mx-auto grid md:grid-cols-3 gap-8 px-6">
            <div className="bg-white/10 p-6 rounded-2xl shadow-lg hover:shadow-pink-500/30">
              ...
              <p className="text-gray-300">
                Understand business goals, target users, and competitors to set
                a strong foundation.
              </p>
            </div>
            <div className="bg-white/10 p-6 rounded-2xl shadow-lg hover:shadow-pink-500/30">
              ...
              <p className="text-gray-300">
                Create low to high-fidelity wireframes and interactive
                prototypes to map user journeys.
              </p>
            </div>
            <div className="bg-white/10 p-6 rounded-2xl shadow-lg hover:shadow-pink-500/30">
              <h4 className="text-xl font-semibold mb-3">
              ...
              <p className="text-gray-300">
                Apply modern UI trends, ensure accessibility, and conduct
                usability testing for perfection.
              </p>
            </div>
          </div>
        </section>
        ...
        <section id="about" className="py-20 bg-black/30 text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-lg text-gray-300">
            I’m Vinod Mathur, a passionate UI/UX Designer who loves turning
            complex problems into elegant design solutions. With years of
            experience in crafting intuitive digital interfaces, I focus on
            creating meaningful user experiences that blend usability,
