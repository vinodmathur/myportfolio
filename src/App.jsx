      ...
      <div className="min-h-screen bg-black/50">
        ...
        <section className="relative flex flex-col items-center justify-center text-center min-h-screen px-6 pt-24">
          ...
          <img
            src="/vector1.png"
            alt="Floating Vector"
            className="absolute top-1/1 left-1/1 -translate-x-1/2 -translate-y-1/2 w-[200px] h-[300px] md:w-[100px] md:h-[500px] sm:w-[300px] sm:h-[300px] animate-bounce-slow opacity-100 -z-10"
          />
